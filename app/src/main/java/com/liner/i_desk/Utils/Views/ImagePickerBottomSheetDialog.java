...
import com.liner.i_desk.Adapters.ImagePickerAdapter;
...
public class ImagePickerBottomSheetDialog extends BaseBottomSheet {
    ...
    private ImagePickerBottomSheetDialog(Builder builder) {
    ...
    public static class Builder {
        ...
        public Builder build() {
            this.dialog = new ImagePickerBottomSheetDialog(this);
            return this;
        }
        ...
        public ImagePickerBottomSheetDialog getDialog() {
            return dialog;
        }
    }
}