...
import com.liner.views.bottomsheetcore.listeners.AnimatorListenerAdapter;
import com.liner.views.bottomsheetcore.util.Preconditions;
import com.liner.views.bottomsheetcore.util.Utils;

import static com.liner.views.bottomsheetcore.util.Utils.IS_AT_LEAST_LOLLIPOP;
...
abstract class BottomSheetContainer extends FrameLayout implements BottomSheet {
    ...
    private void postViewShowingAction(final boolean animate) {
        postPendingViewManagementAction(new Runnable() {
            @Override
            public void run() {
                BottomSheetContainer.this.expandSheet(animate);
            }
        });
    }
    ...
    private void postViewDismissingAction(final boolean animate) {
        postPendingViewManagementAction(new Runnable() {
            @Override
            public void run() {
                BottomSheetContainer.this.collapseSheet(animate);
            }
        });
    }
