...
class UIHelper {
    ...
    private static final Map<View, ValueAnimator> _runningObjectAnimators = new ConcurrentHashMap<>();
...
//    }
    ...
    private static void performSlideAnimation2(final View view, final boolean slideUp) {
    ...
    private static void endPreviousAnimationIfNecessary(View view) {
        if (_runningObjectAnimators.containsKey(view)) {
            ValueAnimator previousAnimator = _runningObjectAnimators.get(view);
