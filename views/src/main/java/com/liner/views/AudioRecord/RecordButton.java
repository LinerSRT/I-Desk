...
public class RecordButton extends AppCompatImageView implements View.OnTouchListener, View.OnClickListener {
    ...
    void startScale() {
        ...
        ObjectAnimator scaleY = ObjectAnimator.ofFloat(this, "scaleY", 2f);
        ObjectAnimator scaleX = ObjectAnimator.ofFloat(this, "scaleX", 2f);
        set.setDuration(150);
    ...
    void stopScale() {
        ...
        ObjectAnimator scaleX = ObjectAnimator.ofFloat(this, "scaleX", 1.0f);
        set.setDuration(150);
        set.setInterpolator(new AccelerateDecelerateInterpolator());
        set.playTogether(scaleY, scaleX);
        set.start();
